 ...
 * ****************************************************************************
 */
public class OperationWaybillFST extends StringIdBean {
    ...
    public OperationWaybillFST() {
        super();
    }

    public OperationWaybillFST(String waybillNo) {
        super();
    ...
    */
    ...
    public boolean equals(Object obj) {
        ...
        if (null != obj && getClass() != obj.getClass())
            return false;
        OperationWaybillFST other = (OperationWaybillFST) obj;
        if (null == other)
            return false;
        if (waybillId == null) {
